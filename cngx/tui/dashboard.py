"""Rich live terminal dashboard for the cngx proxy."""
...
from cngx.tui.alerts import format_alert_panel, format_session_warning_panel
...
class LiveDashboard:
    ...
    def _render(self) -> Layout:
        ...
        layout["header"].update(
            Panel(
                "[bold white]cngx[/] [dim]live watch[/]\n"
