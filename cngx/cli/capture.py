...
def run_capture(
    ...
    Example:
        cngx capture run "Solve 2x + 5 = 13" --task math --model gpt-4o
    """
    from cngx.capture.tracer import CngxTracer

    tracer = CngxTracer(adapter=adapter, model=model, temperature=temperature)
...
def mock_capture(
    ...
    tracer = CngxTracer(adapter="mock", model="mock-model", preset=preset)
