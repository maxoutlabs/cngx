...
def detect_drift(
    ...
    Example:
        cngx drift detect math --baseline math_v1 --window 48
    """
...
def watch_drift(
    ...
    Example:
        cngx drift watch math --baseline math_v1 --threshold 0.5
    """
    import time
...
def quick_check(
    ...
    Example:
        cngx drift quick math_v1 trace_abc123
    """
    from cngx.drift.detector import DriftDetector
