...
from cngx.core.exceptions import BaselineNotFoundError, StorageError, TraceNotFoundError
...
logger = logging.getLogger("cngx.storage")
...
class Database:
    """DuckDB-based storage for cngx data.
    ...
    def __init__(self, db_path: "str | Path"):
        ...
        mem_limit = os.getenv("CNGX_DB_MEMORY_LIMIT", "512MB")
        try:
