...
from cngx.drift.semantic import get_semantic_analyzer
from cngx.drift.trajectory import detect_verification_collapse, verification_health_label
from cngx.fingerprint.extractor import FingerprintExtractor
from cngx.observability.otel import emit_capture_span, is_otel_enabled
from cngx.proxy.events import CaptureEvent, get_event_bus
from cngx.storage.database import get_database

logger = logging.getLogger("cngx.proxy.analysis")

_semantic_enabled: bool = False


def set_semantic_analysis_enabled(enabled: bool) -> None:
    """Enable optional local embedding drift (requires cngx[semantic])."""
