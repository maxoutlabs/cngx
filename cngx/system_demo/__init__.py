"""cngx System Demo - Reference AI pipeline demonstrating system-level enforcement.
...
4. Demonstrates cngx's value as the ONLY protection against silent regression
