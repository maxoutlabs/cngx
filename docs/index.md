...
Standalone binaries (no Python) are on [GitHub Releases](https://github.com/maxoutlabs/cngx/releases).
...
MIT. See [LICENSE](https://github.com/maxoutlabs/cngx/blob/main/LICENSE) in the repository.
