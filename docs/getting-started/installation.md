...
On each [GitHub Release](https://github.com/maxoutlabs/cngx/releases), CI attaches platform binaries built with PyInstaller:
...
See the [Dockerfile](https://github.com/maxoutlabs/cngx/blob/main/Dockerfile) header comments for details.
