...
[![CI](https://github.com/maxoutlabs/cngx/actions/workflows/ci.yml/badge.svg)](https://github.com/maxoutlabs/cngx/actions/workflows/ci.yml)
...
Runs entirely on your machine. Commands run in your shell as you. Nothing is uploaded. Optional trace history lives in `.cngx/` (DuckDB). See [proxy and privacy](https://github.com/maxoutlabs/cngx/blob/main/docs/guides/proxy-and-privacy.md).

## Docs

- [Quickstart](https://github.com/maxoutlabs/cngx/blob/main/docs/getting-started/quickstart.md)
- [Gate a coding agent in CI](https://github.com/maxoutlabs/cngx/blob/main/docs/guides/gate-coding-agent.md)
- [CLI reference](https://github.com/maxoutlabs/cngx/blob/main/docs/cli/reference.md)
- [Session drift (advanced)](https://github.com/maxoutlabs/cngx/blob/main/docs/concepts/drift.md)
- [Contributing](https://github.com/maxoutlabs/cngx/blob/main/CONTRIBUTING.md)
